...
```
### Результати виконання програми на Python для перевірки 

<img width="305" height="418" alt="image" src="https://github.com/user-attachments/assets/d8b6f823-bc2d-49db-a60c-7021c55888cb" />
...
5. **Особливості Common Lisp**:
   - Реалізація через `cond` для різних випадків
